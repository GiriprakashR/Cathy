        ...
        async def on_message(message):
            ...
            #         return
                ...
                await message.channel.send("__*** " +
                                                            ...
                                                            "10 results found from Reddit Websearch! ***__") #newly added
                for item in items_list[0:10]:
                    link_ = "**" + "\n" + item['data']['title'] + "**" + "\n" + item['data']['url']
                    # print(link_)
                    await message.channel.send(link_) #newly added
                ...
                await message.channel.send("__*** " + str(
                    results_length_stack) + " results found from stack overflow! ***__")#newly added
                for item in items_list:
                    link_ = "**" + "\n" + item['title'] + "**" + "\n" + item['link']
                    # print(link_)
                    await message.channel.send(link_)#newly added
                if results_length_stack == 0 and results_length_reddit == 0:
                    await message.channel.send("No Results found! Please refine your search")#newly added
